...
@Table(
        name = "irnss_data",
        uniqueConstraints = @UniqueConstraint(columnNames = {"sat", "mjd", "sttime", "source"})
)
@NoArgsConstructor
@AllArgsConstructor
public class IrnssData {
    ...
    private String mode; // add this field if you're parsing it


    private String source; // To differentiate between file1/file2
